...
5. I have developed to main codes to have a global view of the dataset or just of one epoch folder:<br/><br/>
5.1. In case you want to work with only *one epoch folder*:<br/>
           - Use onlyoneepoch.m function<br/>
           - Go inside the epoch folder you want<br/>
           - Run the code<br/><br/>
5.2. In case you want to have a *general view of the dataset*<br/>
